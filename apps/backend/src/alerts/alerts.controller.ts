...
export class AlertsController {
  ...
  async findAll(@Query() filters: AlertFiltersDto): Promise<unknown> {
  ...
  async getRecentCritical(): Promise<unknown> {
  ...
  async getTimeline(@Query('hours') hours?: number): Promise<unknown> {
