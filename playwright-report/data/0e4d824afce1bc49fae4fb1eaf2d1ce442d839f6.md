...
- Name: mfa.spec.ts >> Validation du flux MFA (Multi-Factor Authentication) - Intégration Réelle >> doit refuser la connexion avec un code TOTP invalide
- Location: apps\frontend\e2e\mfa.spec.ts:29:7
