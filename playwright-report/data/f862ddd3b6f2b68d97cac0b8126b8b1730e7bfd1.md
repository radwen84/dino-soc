...
- Name: auth.spec.ts >> Authentification Frontend - Intégration Réelle >> Affiche un message d'erreur avec des identifiants invalides
- Location: apps\frontend\e2e\auth.spec.ts:37:7
