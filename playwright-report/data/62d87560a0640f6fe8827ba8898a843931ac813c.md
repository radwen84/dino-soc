...
- Name: mfa.spec.ts >> Validation du flux MFA (Multi-Factor Authentication) - Intégration Réelle >> permet de renoncer à l étape MFA et de revenir aux identifiants
- Location: apps\frontend\e2e\mfa.spec.ts:49:7
